...
export const AddToCartHeader = ({ children }) => {
    ...
    return (
        ...
        <div className="flex justify-between px-10 gap-x-10 lg:gap-x-20 h-8 lg:h-16">

            <div className="flex gap-x-5 lg:gap-x-20 items-center sm:justify-between flex-wrap gap-y-5 px-5 lg:px-20 py-2 bg-yellow-300 rounded-t-3xl lg:rounded-t-full w-full">
